...
const SHOWS = [
  {
    id: 1,
    label: 'Next Up',
    name: 'PensaPride 2026: Summerween',
    dates: 'June 13, 2026',
    location: 'Pensacola, FL',
    details: 'A sober, all-ages celebration of art, community, and pop culture at the Pensacola Interstate Fairgrounds. Come find us among 100+ makers and small businesses.',
    image: '/images/shows/pensacola-pride-bag.jpg',
    imageAlt: 'Pensacola Pride bag — Love Wins',
  },
  {
    id: 2,
    label: 'Coming Up',
    name: 'Dragon Con 2026',
    dates: 'Sep 3 – 7, 2026',
    location: 'Atlanta, GA',
    details: 'One of the largest pop culture conventions in the country. Find us in the vendor hall — new designs dropping here first.',
    image: '/images/shows/dragon-con-bag.jpg',
    imageAlt: 'Dragon Con — crimson quilted bag',
  },
  {
    id: 3,
    ...
    location: 'Pensacola, FL',
    details: 'Pensacola\'s own pop culture convention — comics, anime, sci-fi, horror, gaming, and fantasy all under one roof. A home show for us.',
    image: '/images/shows/pensacola-historic-bag.png',
    imageAlt: 'Pensacola Florida Historic bag — Pensacon exclusive',
  },
]
